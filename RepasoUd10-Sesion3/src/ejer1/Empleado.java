...
public class Empleado {
	...
	public Empleado(int EMPNO, String ENAME, String JOB, int MRG, Date HIREDATE, double SAL, double COMM, int DEPTNO) {
		super();
		numero = EMPNO;
		nombre = ENAME;
		puesto = JOB;
	...
	public String toString() {
		return "\nEmpleado [numero=" + numero + ", nombre=" + nombre + ", puesto=" + puesto + ", jefe=" + jefe
				+ ", antiguedad=" + antiguedad + ", salario=" + salario + ", comisión=" + comision + ", departamento="
				+ departamento + "]";
	}
