...
public class AccesoBdatos {
	...
	public Empleado busquedaPorCodigo(int numero) {
		...
		try {
			...
			if ((reg.next())) {
				empleado.setEMPNO(reg.getInt(1));
				empleado.setENAME(reg.getString(2));
				empleado.setJOB(reg.getString(3));
				empleado.setMGR(reg.getInt(4));
				empleado.setHIREDATE(reg.getDate(5));
				empleado.setSAL(reg.getDouble(6));
				empleado.setCOMM(reg.getInt(7));
				empleado.setDEPTNO(reg.getInt(8));
			} else {
				empleado = null;
			}
		} catch (SQLException e) {
