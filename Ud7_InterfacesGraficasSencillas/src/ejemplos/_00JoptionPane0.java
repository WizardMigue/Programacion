...
public class _00JoptionPane0 {
	...
	public static void main(String[] args) {
		...
		JOptionPane.showMessageDialog(null, "El ordenador se reiniciará en dos segundos", "Atención",
				JOptionPane.WARNING_MESSAGE);
		JOptionPane.showMessageDialog(null, "Error en la línea 20", "Error de Compilación", JOptionPane.ERROR_MESSAGE);
		String numeroString = JOptionPane.showInputDialog("Introduzca una cantidad entera");
		int numero = Integer.parseInt(numeroString);
		int numero1 = Integer.parseInt(JOptionPane.showInputDialog("Introduzca una cantidad entera"));
