...
import Ejercicio3_Sesion1.AccesoBdatos;
	...
	private void initialize() {
		...
		BottBuscar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				try {
					...
					if (posicion < 1) {
						JOptionPane.showMessageDialog(frmBusquedaDeSocios,
								"No existen registros en " + textFieldBuscar.getText(), "Error",
					...
					lblNewLabelPosiciones
							.setText("Socio " + String.valueOf(listado.getRow()) + " de " + String.valueOf(posicion));
		...
		btnAnterior.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					if (listado.isFirst())
						JOptionPane.showMessageDialog(frmBusquedaDeSocios, "No existen registros anteriores",
		...
		btnSiguiente.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					if (listado.isLast())
						JOptionPane.showMessageDialog(frmBusquedaDeSocios, "No existen registros posteriores",
								"Ultimo Socio", JOptionPane.INFORMATION_MESSAGE, null);
					else
						listado.next();
					textFieldSocio.setText(listado.getString(1));
					textFieldNombre.setText(listado.getString(2));
